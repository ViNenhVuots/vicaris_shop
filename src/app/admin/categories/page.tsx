    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
        <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-4">
          <Folders className="text-gray-400" size={32} />
        </div>
        <h2 className="text-xl font-medium text-gray-900 mb-2">Chưa có dữ liệu danh mục</h2>
        <p className="text-gray-500 max-w-md mx-auto mb-6">
          Tính năng quản lý danh mục đang được hoàn thiện. Bạn sẽ sớm có thể phân loại sản phẩm của mình tại đây.
        </p>
      </div>
    </div>
  );
