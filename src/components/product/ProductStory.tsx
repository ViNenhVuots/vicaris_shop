  ...
  const stories = [
    {
      ...
      img: "https://images.unsplash.com/photo-1594498653385-d5172c532c00?q=80&w=1200&auto=format&fit=crop"
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1512414584143-b9a3e3484950?q=80&w=1200&auto=format&fit=crop"
    },
    {
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1611080780287-c1d42a8b9e66?q=80&w=1200&auto=format&fit=crop"
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1513258525046-24e64f891b65?q=80&w=1200&auto=format&fit=crop"
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1529156069898-49953eb1b5ce?q=80&w=1200&auto=format&fit=crop"
    }
  ];
          ...
          {stories.map((story, idx) => (
            <div key={idx} className={`flex flex-col md:flex-row items-center gap-12 lg:gap-24 ${idx % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
              <div className="w-full md:w-1/2 relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                <Image src={story.img} alt={story.title} fill className="object-cover hover:scale-105 transition-transform duration-700" sizes="(max-width: 768px) 100vw, 50vw" />
              </div>
